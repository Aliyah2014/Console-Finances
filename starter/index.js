...
for (var i = 0; i < finances.length; i++) {
  var currentMonthArray = finances[i];
  var currentMonthBalance = currentMonthArray[1];
  //console.log (currentMonthBalance)
  totalSum = currentMonthBalance + totalSum;
  // totalSum += currentMonthBalance
}
console.log("Total: $" + totalSum);

// The average of the changes in Profit/Losses over the entire period.
var balanceDifferences = []
var TotalDifference = 0;
for (var i = 1; i < finances.length; i++) {
  var currentMonthBalance = finances[i][1];
